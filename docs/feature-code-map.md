...
| Library | `GET /api/library`, paged `GET /api/library?limit=50&page=N`, async scoped `POST /api/library/reindex`, `POST /api/favorites` | library index, `library_reindex` internal job queueing, and favorite helpers |
