...
| YouTube subscriptions | `/api/subscriptions`, `/api/subscriptions/{id}`, `/api/subscriptions/{id}/items`, create/update/delete, manual `/check`, item `/queue`, `/skip`, `/retry` | subscription API functions around `app/main.py` subscription section |
