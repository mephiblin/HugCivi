...
| Settings/folders | `POST /settings`, legacy `POST /folders`, `GET/POST /api/folders` | `save_settings`, `create_folder`, `api_folders`, `api_create_folder`, `build_folder_tree` |
