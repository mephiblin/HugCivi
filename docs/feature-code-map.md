...
| `tests/test_transfer_api.py` | Transfer API target CRUD, local mount and Receiver tree browsing, ComfyUI folder-check endpoint, copy-only API validation, source/path safety, internal job creation, manifest writing, and transfer template affordances. |
