...
| `/config/media-cache` | media cache | Browser MP4 transcodes, poster files, and lazy card thumbnails under `thumbnails/`. TTL and optional max-byte cleanup. |
